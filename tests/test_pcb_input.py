...
def payload():
    return {"length": measure(60), "width": measure(40), "thickness": measure(1.6), "max_component_height": measure(12, False), "mounting_holes": [{"x": measure(5), "y": measure(5), "diameter": measure(3)}, {"x": measure(55), "y": measure(35), "diameter": measure(3)}], "interfaces": [{"name": "USB-C", "x": measure(50), "y": measure(10), "width": measure(8), "height": measure(4)}], "keepouts": [{"x": measure(20), "y": measure(10), "width": measure(10), "height": measure(10)}]}
...
@pytest.mark.parametrize("mutate", [lambda p: p["length"].update(unit="inch"), lambda p: p["mounting_holes"][0]["x"].update(value=-1), lambda p: p["interfaces"][0]["width"].update(value=20)])
